...
class ArtifactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artifact" do
    assert_difference('Artifact.count') do
      post artifacts_url, params: { artifact: { key: @artifact.key, name: @artifact.name, project: @artifact.project } }
    end
  ...
  test "should update artifact" do
    patch artifact_url(@artifact), params: { artifact: { key: @artifact.key, name: @artifact.name, project: @artifact.project } }
